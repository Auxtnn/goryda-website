...
<section className=" px-2 py-10">
  ...
  <p className="text-center text-base leading-7 md:max-w-2xl md:mx-auto">
  ...
  <ul className="mt-16 grid  md:px-10 md:gap-16 mx-6 grid-cols-1 gap-8 text-center md:grid-cols-3">
    <li className="rounded bg-white md:px-6 px-3 py-8 shadow-md border">

     <MdAirlineSeatLegroomExtra className="mx-auto h-10 w-10 text-green-500" />
