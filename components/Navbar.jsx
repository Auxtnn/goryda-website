      ...
      <nav className="p-4 border">
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            ...
            >
              <Link href="/about" className="block mb-2 hover:text-green-500">
                About
              </Link>
              <Link href="/services" className="block mb-2 hover:text-green-500">
                Services
              </Link>
              <Link href="/faq" className="block mb-2 hover-text-green-500">
                FAQ
              </Link>
              <Link href="/support" className="block mb-2 hover-text-green-500">
                Support
              </Link>
              <Link
                href="/book-ride"
                className="block bg-green-500 text-white rounded py-2 px-4 hover-bg-transparent hover-border-green-700 border"
              >
                Book Ride
              </Link>
            </motion.div>
