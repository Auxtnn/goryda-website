          ...
          <div className="">
            <div className="border border-gray-200 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                Our commitment is to provide consistent, on-time services that
                our users can depend on.
              </p>
            </div>
          </div>
          <div className="">
            <div className="border border-gray-200 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                We implement rigorous safety standards to ensure the well-being
                of both our riders and customers.
              </p>
            </div>
          </div>
          <div className="">
            <div className="border border-gray-200 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                With advanced tech and optimized routes, we make every ride and
